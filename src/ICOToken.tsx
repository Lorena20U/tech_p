...
import YACoinTokenArtifacts from "./artifacts/contracts/YACoinToken.sol/YACoinToken.json";
import YACoinTokenCrowdsaleArtifacts from "./artifacts/contracts/YACoinTokenCrowdsale.sol/YACoinTokenCrowdsale.json";
import logger from "./logger";
import { type YACoinToken, type YACoinTokenCrowdsale } from "./types";
...
function TokenInfo({ tokenAddress }: { readonly tokenAddress: string }) {
  ...
  const fetchTokenInfo = async () => {
    ...
    const tokenContract = new ethers.Contract(tokenAddress, YACoinTokenArtifacts.abi, provider) as YACoinToken;
...
function ICOToken({ crowdsaleAddress }: Props) {
  ...
  const fetchCrowdsaleTokenInfo = () => {
    ...
    const contract = new ethers.Contract(
      crowdsaleAddress,
      YACoinTokenCrowdsaleArtifacts.abi,
      provider,
    ) as YACoinTokenCrowdsale;
        ...
        <>
          <div className="alert">
            <div className="flex-1">
              ...
              <label>Please connect to the Sepolia testnet for testing.</label>
            </div>
          </div>
      ...
      <div className="flex items-center py-10 px-4 w-full bg-cover card bg-base-200">
        ...
        <div className="text-center shadow-2xl card">
          <div className="card-body">
            <h2 className="card-title">YACoin Token</h2>
