...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "YACoinToken",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.YACoinToken__factory>;
    getContractFactory(
      name: "YACoinTokenCrowdsale",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.YACoinTokenCrowdsale__factory>;
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.YACoinToken>;
    getContractAt(
      name: "YACoinTokenCrowdsale",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.YACoinTokenCrowdsale>;
